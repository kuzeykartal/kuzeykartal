# Hi there, I'm Kuzey Kartal Türkoğlu 👋

### 🚀 Frontend Developer | Interactive Technologies Student at UPV Gandia

I am a design-oriented Frontend Developer based in Spain, passionate about creating modern, responsive, and user-focused digital experiences. Currently, I'm exploring the intersection of technology and creativity while building real-world projects.

---

### 🌍 Languages & Education
- 🎓 **Education:** Grado en Tecnologías Interactivas @ Universitat Politècnica de València (UPV)
- 📍 **Location:** Gandia, Spain / Kırklareli, Turkey
- 🗣️ **Languages:**
  - 🇹🇷 **Turkish:** Native
  - 🇬🇧 **English:** Intermediate / Professional
  - 🇪🇸 **Spanish:** Intermediate (B1/B2 - Improving every day!)

---

### 🛠️ Tech Stack & Tools
- **Frontend:** HTML5, CSS3, JavaScript (ES6+), React, Vite
- **Design:** UI/UX Design, Figma, Creative Strategy
- **Tools:** Git, GitHub, VS Code, Deployment (Firebase, Vercel)
